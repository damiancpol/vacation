...
<c:choose>
	...
	<div id="tt"
		...
		<div
			style="margin-left: 300px; color: #15062c; font-size: 25px; font-family: Andale Mono;; margin-right: auto">Nowy
			Wniosek</div>
		<br> <br>
		<f:form modelAttribute="up" action="saveWniosek">
			<div style="background: #EEEEEE; width: full">


				<div style="font-weight: bold; margin-left: 150px; font-size: 14px">
					Imię i nazwisko <font color="blue">${uss.imie}
						${uss.nazwisko}${ll}</font><br> <span style="color: red">${message}${dataP}</span>
				</div>
				...
				<div style="font-weight: bold; margin-left: 150px; font-size: 14px">
					Dział <font color="blue">${uss.dzial}</font>
				</div>
			...
			<tr>
				...
				<div class="container">
					...
					<div class="col-md-3" style="margin-left: 140px; font-weight: bold">
						...
						<tr>
							<td>Liczba dni wolnych:</td>
							<td><f:input  path="liczbadniurlopu" /></td>
					...
					<tr><span
						style="font-weight: bold; font-size: 14px; margin-left: 140px;">
						<td>Liczba godzin urlopu</td>
					</span><td>
<f:select path="liczbagodzinurlopu">
							<f:option selected="selected" value="0"></f:option>
					...
					<td><f:select path="zastepstwo">
							...
							<c:choose>
							<c:when test="${i.kierownik eq uss.kierownik}">
...
${i.imie} ${i.nazwisko}
			...
			<tr>
				<td><span
					style="font-weight: bold; font-size: 14px; margin-left: 140px;">Komentarz</span></td>
			</tr>
			<br>
			<div style="margin-left: 140px">
				...
				<br> <br> <input type="submit" value="Utwórz wniosek"
