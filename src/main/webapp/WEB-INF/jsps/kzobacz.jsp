...
<c:choose>
	...
	<div	style="color: black; font-family: Andale Mono; float: left; margin-left: 60px; margin-top: 130px;border: 1px solid silver;width:800px;background: white">
	<div style="margin-left:300px;color:#15062c;font-size: 25px;font-family: Andale Mono;;margin-right:auto">Nowy Wniosek</div><br><br>
				...
				<div style="font-weight: bold;margin-left:150px;font-size:14px">	Imię i nazwisko	<font   color="blue">${urlop.title}</font></div>
				
				
				<br>
				
			
			<div style="font-weight: bold;margin-left:150px;font-size:14px">		dzial/Dział	<font color="blue">${urlop.dzial}</font></div>
...
<c:url value="zatwierdz" var="zat">
<c:param name="zatw" value="${urlop.idurlopu}"></c:param>

</c:url>
</div><br>

<c:url value="odrzuc" var="odz">
<c:param name="zatw1" value="${urlop.idurlopu}"></c:param>
	...
	<div class="col-md-3"><p class="bg-info" id="result"><span style="font-weight: bold;font-size:14px;margin-left:140px;">Liczba godzin urlopu:${urlop.liczbagodzinurlopu } </span><br></div>
		...
		<tr><td><span style="font-weight: bold;font-size:14px;margin-left:140px;">Komentarz:</span></td>${urlop.description}</tr><br>
		 ...
		 <a href="${zat}" style="text-decoration: none;">
		<div  style="width:100px;float:left;margin-left:250px;height:35px;color:white;font-size:16px;float:left;background: #007fff;border: 1px solid #007fff;border-radius: 10px;text-align: center;">Zatwierdz</div></a>
		<a href="${odz}" style="text-decoration: none;">
		<div  style=" margin-left:50px;float:left;height:35px; width:100px;color:white;font-size:16px;float:left;background: orange;border: 1px solid #007fff;border-radius: 10px;text-align: center;">Odrzuć</div></a>
