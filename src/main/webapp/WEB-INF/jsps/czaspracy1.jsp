...
<c:choose>
	...
	<div id="tt"
		...
		${title}
		<table>
		<tr><td>Wejście</td><td>Wyjście</td><td>Data</td></tr>
		</table>
		<c:forEach items="${pracownikGodziny}" var="i">
		<table>
		<tr><td> <fmt:parseDate value = "${i.wejscie }" var = "parsedEmpDate" pattern = "HH:mm" /><fmt:formatDate type="time" value="${parsedEmpDate}" />  </td>
		
		<td><fmt:parseDate value = "${i.wyjscie}" var = "parsedEmpDate1" pattern = "HH:mm" /><fmt:formatDate type="time" value="${parsedEmpDate1}" />  </td>
		
		
		<td><fmt:parseDate value = "${i.og}" var = "parsedEmpDate2" pattern = "yyyy-MM-dd" /><fmt:formatDate pattern = "yyyy-MM-dd"    value = "${parsedEmpDate2}" /></td></tr>
