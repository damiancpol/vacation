...
<c:choose>
	...
	<div
		...
		<img src="/images/wniosekzapisany.png" style="width:800px;height: auto"/><br>
	<div style="margin-left:300px;color:#15062c;font-size: 25px;font-family: Andale Mono;;margin-right:auto">Nowy Wniosek</div><br><br>
				...
				<div style="font-weight: bold;margin-left:150px;font-size:14px">	Imię i nazwisko	<font   color="blue">${uss.imie} ${uss.nazwisko}
...
<tr><td><span style="font-weight: bold;font-size:14px">Urlop od :  ${urlop.start } do :  ${urlop.end }</span></span></td>
	...
	<div class="col-md-3"><p class="bg-info" id="result"><span style="font-weight: bold;font-size:14px;margin-left:140px;">Liczba godzin urlopu:${urlop.liczbagodzinurlopu } </span><br></div>
		...
		<a href="edytowanie" style="text-decoration: none;">
		<input type="submit" value="Edytuj" style="height:35px;background: #00a000;color:white;font-size:16px;float:left;width:150px;border: 1px solid #00a000;border-radius: 10px;margin-top:50px "></a>
		 <a href="usuwanieWniosku"style="text-decoration: none;">
		<input tyle="submit" value="     Anuluj wniosek" style="margin-left:50px;height:35px; red;width:170px;color:white;font-size:16px;float:left;background: red;margin-top:50px;border: 1px solid red;border-radius: 10px"></a>
		</div>
	</div>
	</div>
</body>
