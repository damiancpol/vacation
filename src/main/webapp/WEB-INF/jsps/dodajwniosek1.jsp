...
<script type="text/javascript" src="/jss/datepicker.js"></script>
<script type="text/javascript" src="/jss/timepicker.js"></script>
...
<c:choose>
	...
	<div
		style="color: black; font-family: Andale Mono; float: left; margin-left: 60px; margin-top: 130px;border: 1px solid silver;width:800px">
...
<tr><td><span style="font-weight: bold;font-size:14px">Urlop od :</span></td><td><f:input path="start"  type="text" name="selected_date" id="datepicker" style="float:left"/></td><td><span style="font-weight: bold;font-size:14px">do :</span></td>
<td><f:input path="end"  type="text" name="selected_date1" id="datepicker1" style="float:left"/></td>
</tr>
</table>
</div>
</div><br>
	
		<div class="col-md-3"><p class="bg-info" id="result"><span style="font-weight: bold;font-size:14px;margin-left:140px;">Liczba dni : </span><br></p></div>
