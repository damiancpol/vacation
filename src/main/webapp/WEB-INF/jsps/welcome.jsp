...
<c:forEach items="${allUrlop}" var="i" begin="0" end="4">
...
<td><span style="color:green;font-size:12px;margin-left:50px"><a href="${zzi}" style="text-decoration: none;color:green;font-weight: bold;">Zobacz</a></span></td>
<td > <br><span style="margin-left:50px">${i.idurlopu}</span></td>
</tr>
</table>
...
<c:url value="checkLogin1" var="tt">
...
<div>
<img src="/images/ulopybok.png" style="width:550px;height:auto;z-index: 0">
<div style="z-index:1;font-size:25px;margin-top:-150px;margin-left:120px;font-weight: bold;font-family: Verdana">${uss.liczbadniwolnych }</div>
</div>
<br><br><br><br><br><br><br><br>
<div style="width:550px;background: white">
<span style="font-weight: bold;font-style: Verdana;margin-left: 10px;margin-top:-5px;font-size:14px">NA URLOPIE</span><BR>
